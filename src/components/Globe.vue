...
// npm install --save @geo-maps/countries-coastline-10km 
// axios core-decorators d3-geo eventemitter2 hammerjs 
// i18n-iso-countries is-touch-device lodash-decorators three vuex
...
const Shaders = {
  earth: {
    ...
    fragmentShader: [
      ...
      'varying vec2 vUv;',
      'void main() {',
      'vec3 diffuse = texture2D( texturesam, vUv ).xyz;',
...
class GlobeRenderer extends EventEmitter2 {
  ...
  init() {
    ...
    // Earth
    {
      ...
      uniforms.texturesam.value = new THREE.TextureLoader().load('./earth.jpg');
  ...
  onTap(ev) {
    ...
    console.log(CountryCode.getName(countryCode, 'zh'));
